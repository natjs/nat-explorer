...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/device/vibration.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-33f1ae3b"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		vibrate: function vibrate() {
			_natjs2.default.vibrate();
		},
		setVibrateDuration: function setVibrateDuration() {
			_natjs2.default.vibrate(2000);
		}
	}
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("Nat.vibrate()")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.setVibrateDuration
    }
  }, [_vm._m(1), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.vibrate(2000)")])])], 1)], 1)
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Set vibrate duration (Android Only)")])])
}]}
module.exports.render._withStripped = true

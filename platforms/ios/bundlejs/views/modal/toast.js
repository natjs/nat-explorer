...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/modal/toast.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b62b07da"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("Nat.toast('What\\'s up')")])]), _c('div', {
    staticClass: ["case"],
    on: {
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Toast with custom duration and position")])])
}]}
module.exports.render._withStripped = true

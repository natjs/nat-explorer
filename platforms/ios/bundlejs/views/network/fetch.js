...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/network/fetch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-a5a9f032"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		...
		fetchWithOpts: function fetchWithOpts() {
			_natjs2.default.fetch(this.url, {
				method: 'PUT',
				type: 'json'
			}, function (err, res) {
				if (err) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("Nat.fetch(this.url, (err, res) => {\n\tif (err) {\n\t\tNat.toast('[ERROR] ' + JSON.stringify(err))\n\t\treturn\n\t}\n\nNat.toast(JSON.stringify(res))\n})")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.fetchWithOpts
    }
  }, [_vm._m(1), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.fetch(this.url, {\n\tmethod: 'PUT',\n\ttype: 'json'\n}, (err, res) => {\n\tif (err) {\n\t\tNat.toast('[ERROR] ' + JSON.stringify(err))\n\t\treturn\n\t}\n\nNat.toast(JSON.stringify(res))\n})")])])], 1)], 1)

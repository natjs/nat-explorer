...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/communication/sms.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5cea656e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		sms: function sms() {
			_natjs2.default.sms('10010');
		},
		smsMulti: function smsMulti() {
			_natjs2.default.sms(['10010', '10086']);
		},
		smsWithContnCb: function smsWithContnCb() {
			_natjs2.default.sms('10010', 'message goes here.', function () {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("Nat.sms(['10010', '10086'])")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.smsWithContnCb
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.sms('10010', 'message goes here.', () => {\n\tNat.toast('sms popup')\n})")])])], 1)], 1)

...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/network/download.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-adfad12a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		download: function download() {
			_natjs2.default.download(this.url).then(function (res) {
				_natjs2.default.toast(JSON.stringify(res));
			}).catch(function (e) {
				_natjs2.default.toast('[ERROR] ' + JSON.stringify(e));
			});
		},
		downloadWithOptsnHook: function downloadWithOptsnHook() {
			_natjs2.default.download(this.url, {
				headers: {
					'nat-version': '0.0.1'
				}
			}, {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Download with options and hooks")])])
}]}
module.exports.render._withStripped = true

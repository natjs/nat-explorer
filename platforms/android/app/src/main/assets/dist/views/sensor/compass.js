...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/sensor/compass.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-563f6f42"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		getHeading: function getHeading() {
			_natjs2.default.compass.get(function (err, ret) {
				if (err) {
		...
		watchHeading: function watchHeading() {
			var _this = this;

			var times = 0;

			_natjs2.default.compass.watch(function (err, ret) {
				times++;
		...
		clearWatchHeading: function clearWatchHeading() {
			_natjs2.default.compass.clearWatch(function (err) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["case"],
    on: {
      "click": _vm.clearWatchHeading
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.compass.clearWatch((err) => {\n\tif (err) {\n\t\tNat.toast('[ERROR] ' + JSON.stringify(err))\n\t\treturn\n\t}\n\tNat.toast('cleared')\n})")])])], 1)], 1)
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Clear watch compass heading")])])
}]}
module.exports.render._withStripped = true

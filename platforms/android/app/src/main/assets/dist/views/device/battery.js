...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/device/battery.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-9410f714"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		getBatteryStatus: function getBatteryStatus() {
			_natjs2.default.battery.status(function (err, ret) {
				if (err) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["case"],
    on: {
      "click": _vm.getBatteryStatus
    }
  }, [_vm._m(0), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.battery.status((err, ret) => {\n\tNat.toast(JSON.stringify(ret, null, 2))\n})")])])], 1)], 1)

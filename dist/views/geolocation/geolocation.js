...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/geolocation/geolocation.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-34d3036a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
	...
	methods: {
		...
		watchLocation: function watchLocation() {
			...
			_natjs2.default.geolocation.watch(function (err, ret) {
				...
				_this.result = JSON.stringify(ret, null, 2);
			});
		},
		clearWatchLocation: function clearWatchLocation() {
			_natjs2.default.geolocation.clearWatch(function (err) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["case"],
    on: {
      "click": _vm.clearWatchLocation
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.geolocation.clearWatch((err) => {\n\tif (err) {\n\t\tNat.toast('[ERROR] ' + JSON.stringify(err))\n\t\treturn\n\t}\n\tNat.toast('cleared')\n})")])])], 1)], 1)

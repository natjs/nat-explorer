...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/device/screen.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-808146da"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		...
		getBrightness: function getBrightness() {
			_natjs2.default.screen.brightness.get(function (err, ret) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
		...
		setBrightness: function setBrightness() {
			_natjs2.default.screen.brightness.set(1, function (err, ret) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
		...
		getOrientation: function getOrientation() {
			_natjs2.default.screen.orientation.status(function (err, ret) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
		...
		lockScreenOrientation: function lockScreenOrientation() {
			_natjs2.default.screen.orientation.lock(function (err, ret) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
		...
		unlockScreenOrientation: function unlockScreenOrientation() {
			_natjs2.default.screen.orientation.unlock(function (err, ret) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
					return;
				}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["case"],
    on: {
      "click": _vm.getScreenInfo
    }
  }, [_vm._m(0), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.screen.info((err, ret) => {\n\tNat.toast(JSON.stringify(ret, null, 2))\n})")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.getBrightness
    }
  }, [_vm._m(1), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.screen.brightness.get((err, ret) => {\n\tNat.toast(ret)\n})")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.setBrightness
    }
  }, [_vm._m(2), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.screen.brightness.set(1, (err, ret) => {\n\tNat.toast(ret)\n})")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.getOrientation
    }
  }, [_vm._m(3), _c('text', {
    staticClass: ["code"]
  }, [_vm._v("Nat.screen.orientation.status((err, ret) => {\n\tNat.toast(ret)\n})")])])], 1)], 1)
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Get screen orientation status")])])
}]}
module.exports.render._withStripped = true

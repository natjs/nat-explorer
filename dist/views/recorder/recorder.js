...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/recorder/recorder.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5c252586"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		...
		play: function play() {
			if (!this.path) {
				_natjs2.default.toast('Please record your audio first :)');
				return;
			}

			_natjs2.default.audio.play(this.path);
		}
	}
};

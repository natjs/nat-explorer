...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/network/upload.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4bc7e1b8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	methods: {
		upload: function upload() {
			if (!this.filePath) {
				_natjs2.default.toast('Please pick a file first :)');
				return;
			}

			_natjs2.default.upload(this.url, {
				path: this.filePath
			}, function (err, res) {
				if (err) {
		...
		uploadWithOptsnHook: function uploadWithOptsnHook() {
			if (!this.filePath) {
				_natjs2.default.toast('Please pick a file first :)');
				return;
			}
			...
			_natjs2.default.upload(this.url, {
				...
				onProgress: function onProgress(p) {
					_natjs2.default.toast('Progressing: ' + p);
				}
			}, function (err, res) {
				if (err) {
					_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
		...
		pick: function pick() {
			...
			_natjs2.default.image.pick().then(function (ret) {
				_this.filePath = ret.paths[0];
				_natjs2.default.toast('picked: ' + _this.filePath);
			}).catch(function (err) {
				_natjs2.default.toast('[ERROR] ' + JSON.stringify(err));
			});
		}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["button", "pick"],
    on: {
      "click": _vm.pick
    }
  }, [_c('text', {
    staticClass: ["button-txt"]
  }, [_vm._v("Pick a file")])]), _c('div', {
    staticClass: ["case"],
    on: {
      "click": _vm.upload
    }
  ...
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("Upload with options and hooks")])])
}]}
module.exports.render._withStripped = true

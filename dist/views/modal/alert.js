...
__vue_options__.__file = "/Users/acathur/Developments/nat/nat-explorer/src/views/modal/alert.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3e16ccc8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('status-bar'), _c('nav-bar'), _c('scroller', {
    ...
    staticClass: ["code"]
  }, [_vm._v("Nat.alert('What\\'s up')")])]), _c('div', {
    staticClass: ["case"],
    on: {
    ...
    staticClass: ["code"]
  }, [_vm._v("Nat.alert('This is an alert with callback', () => {\n\tNat.toast('alerted.')\n})")])])], 1)], 1)
